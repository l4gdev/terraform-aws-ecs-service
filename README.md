...
| <a name="input_capacity_provider_strategy_advance"></a> [capacity\_provider\_strategy\_advance](#input\_capacity\_provider\_strategy\_advance) | n/a | <pre>list(object({<br>    capacity_provider = string<br>    weight            = optional(number, 1)<br>    base              = optional(number, 0)<br>  }))</pre> | n/a | yes |
