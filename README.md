...
| <a name="input_aws_alb_listener_rule_conditions_advance"></a> [aws\_alb\_listener\_rule\_conditions\_advance](#input\_aws\_alb\_listener\_rule\_conditions\_advance) | n/a | <pre>list(object({<br>    name = string<br>    rules = list(object({<br>      type             = string<br>      values           = list(string)<br>      http_header_name = optional(string, null)<br>    }))<br>    auth = optional(object({<br>      type                                = string<br>      authorization_endpoint              = optional(string, null)<br>      client_id                           = optional(string, null)<br>      client_secret                       = optional(string, null)<br>      issuer                              = optional(string, null)<br>      token_endpoint                      = optional(string, null)<br>      user_info_endpoint                  = optional(string, null)<br>      authentication_request_extra_params = optional(list(string), null)<br>      on_unauthenticated_request          = optional(string, null)<br>      scope                               = optional(string, null)<br>      session_cookie_name                 = optional(string, null)<br>      session_timeout                     = optional(number, null)<br>      user_pool_arn                       = optional(string, null)<br>      user_pool_client_id                 = optional(string, null)<br>      user_pool_domain                    = optional(string, null)<br>    }), null)<br>  }))</pre> | `null` | no |
